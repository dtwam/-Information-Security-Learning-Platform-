...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  "auth.subtitle.login": { en: "Welcome back to TechSec QOU", ar: "مرحباً بعودتك إلى أكاديمية تيك سيك" },
  "auth.subtitle.signup": { en: "Join TechSec QOU academy", ar: "انضم إلى أكاديمية تيك سيك — جامعة القدس المفتوحة" },
  ...
  // Hero
  "hero.title": { en: "TechSec QOU", ar: "تيك سيك" },
  "hero.tagline": { en: "Cybersecurity Academy · Al-Quds Open University", ar: "أكاديمية تيك سيك — جامعة القدس المفتوحة" },
  "hero.subtitle": { en: "The official academy for Information Systems & Information Security students at Al-Quds Open University.", ar: "الأكاديمية الرسمية لطلاب أنظمة المعلومات وأمن المعلومات في جامعة القدس المفتوحة." },
